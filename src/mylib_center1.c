...
void create (Account **root){
    ...
    do {
        ...
        if (isAccountExistInFile("database/ambank.txt", accountNumber)) {
            clear();
            gotoxy(33, 13);
            printf("==========================================================================");
            gotoxy(33, 14);
    ...
    } while (isAccountExistInFile("database/ambank.txt", accountNumber)); // Ulangi jika nomor akun sudah ada
    ...
    *root = addAccount(*root, accountNumber, pin, balance);
    ...
    printf("================================================================");
    gotoxy(38,21);
    printf("            Terimakasih telah mempercayai AMBANK             ");
    gotoxy(38,22);
    printf("================================================================");
